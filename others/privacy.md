...
At Morpheum Foundation (also known as "morpheum", referred to here as "we", "us" or "our"), we respect and protect the privacy of those users and developers ("you" and "your" or "Users" and "Developers", as relevant) who explore and use Morpheum through our platform or any other applications, tools, and features we operate (collectively, the "Services"). This Privacy Policy describes how we collect, use, and disclose personal information when you use our Services, which include the services offered on our website(s) at https://www.morpheum.foundation. This Privacy Policy does not apply to any processing which Morpheum Foundation carries out as a processor on behalf of those Users and Developers who explore and use Morpheum. Please note that we do not control websites, applications, or services operated by third parties, and we are not responsible for their actions. We encourage you to review the privacy policies of the other websites, decentralized applications, and services you use to access or interact with our Services.
...
- Where you agree to engage in our surveys or sign up to receive marketing communications about Morpheum products and offerings, we will ask for the following "Basic User Information":
  - Name
  - Email
...
- **Information from Morpheum Foundation Companies ("Affiliates"):** We may obtain information about you, such as Basic User Information from our Affiliates as part of facilitating, supporting, or providing our Services.
...
- **Error Tracking Data:** We utilize information from third-party service providers to provide automated error monitoring, reporting, alerting, and diagnostic capture for Service and Site errors to allow Users or Developers to build more effectively on the Morpheum platform.
...
|---------|------------------|-----------------|
| To provide you with the Morpheum Services | Wallet Address, Blockchain Data | Contractual Necessity |
...
| To allow Users or Developers to build more effectively on the Morpheum platform | Error Tracking Data | Legitimate Interests |
| To send you Morpheum forms for marketing and product development | Basic User Information | Legitimate Interests |
...
- We rely primarily on the European Commission's Standard Contractual Clauses to facilitate the international and onward transfer of European Personal Data to third countries, including from our EU operating entities to Morpheum Foundation, who provides the primary infrastructure for the Services.
...
If you have questions or concerns regarding this Privacy Policy, or if you have a complaint, please contact us via email at privacy@morpheum.io.
